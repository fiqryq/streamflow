    ...
    <AuthenticatedLayout>
      <div>
        <div className="mb-8">
          ...
          <p className="text-gray-400 mt-2">Manage your video files</p>
        </div>

        <div className="bg-dark-800 rounded-lg border border-gray-700 p-6">
          <div className="text-center py-12">
            <i className="ti ti-video text-6xl text-gray-600 mb-4"></i>
            <p className="text-gray-400">Gallery page - Implementation in progress</p>
